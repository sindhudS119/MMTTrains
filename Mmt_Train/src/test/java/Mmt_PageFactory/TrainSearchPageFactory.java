...
public class TrainSearchPageFactory {
	...
	//-------------------------------------------------------------------------------------	
		...
		@FindBy(xpath="//span[text()=\"Train Start Date\"]")
	    WebElement clickdate;
		
		@FindBy(xpath="//span[text()=\"Day Before Yesterday\"]")
	    ...
	    WebElement livestatuscheck;
	     ...
	     @FindBy(xpath="//div[@class=\"cardHeadingText blackText\"]/child::h2[@data-cy=\"pnrNumber\"]")
	     WebElement assert3;
	     
	     @FindBy(xpath="//p[text()=\"This PNR is either not generated or flushed\"]")
	     WebElement assert4;
	     @FindBy(xpath="//p[text()=\"udyan express\"]")
	     WebElement assert5;
	...
	//--------------------------------------------------------------------------------
		...
		{
			ExplicitWait(filter,10);
			filter.click();
			}
		
		public String AssertFilter()
		{
			ExplicitWait(assert2,5);
...
//			System.out.println(s3);
			ExplicitWait(assert3,8);
			return assert3.getText();
		}
		public String assertinvalid()
		{
			ExplicitWait(assert4,10);
			return assert4.getText();
		}
	//---------------------------------------------------------------------------------	
...
////			ExplicitWait(dateinput,10);
			//dateinput.click();
//			Thread.sleep(2000);
//			driver.findElement(By.xpath("//span[text()=\"Train Start Date\"]")).click();
//			Thread.sleep(2000);
//			driver.findElement(By.xpath("//span[text()=\"Day Before Yesterday\"]")).click();
...
//			r.mouseRelease(InputEvent.BUTTON1_DOWN_MASK);
		...
		public String assertlivestatus()
		{
			ExplicitWait(assert5,5);
		  String s5=assert5.getText();
		   System.out.println(s5);
		   ExplicitWait(assert5,5);
			return assert5.getText();
		}
